    ...
    <section class="container">
      ...
      <div class="row">
        <div class="col-md-6 offset-md-3">
          <form
            class="bg-light rounded p-4 box-shadow"
            method="POST"
            action="adiciona-usuario.php"
          >
              ...
              <div class="option form-check-inline">
                ...
                <div class="custom-control custom-checkbox form-check-inline">
                  <input
                    ...
                    value="Contábil"
                  />
                  <label class="custom-control-label" for="Contábil"
                    >Contábil</label
                  >
                </div>
                <div class="custom-control custom-checkbox form-check-inline">
                  <input
                    ...
                    value="Financeiro"
                  />
                  <label class="custom-control-label" for="Financeiro"
                    >Financeiro</label
                  >
                </div>
              </div>
          ...
          <table class="table">
            ...
            ?>
              <tr>
                ...
                <td class="align-middle">
                  <a
                    href="deleta-usuario.php?_indice=<?= $key; ?>"
